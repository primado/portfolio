...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="flex flex-row justify-between bg-[#eff2f1] items-center h-[5rem] lg:px-[10rem] sm-425:px-[2rem] md-768:px-12 sm-280:!px-5 px-16 py-8">
                <div className="">
                ...
                <div className="text-black">
                    <ul className="flex flex-row gap-12 sm-280:gap-3">
                        <li>
