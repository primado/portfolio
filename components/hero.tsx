            ...
            <div className=" md-768:px-12 px-12">
                <div className="flex flex-col gap-y-16 justify-center items-center gap-3 sm-425:px-5 sm-430:px-1">
                    <div className="flex flex-col justify-center items-center gap-y-3 sm-425:gap-y-3">
                        <h1 className="text-black text-5xl text-center font-semibold break-words sm-320:text-3x sm-425:p-3 sm-425:w-full sm-425:h-[12rem] sm-320:h-[7rem] sm-430:h-[12rem] sm-280:border-2 sm-280:border-black sm-280:!w-[17.8rem] sm-280:h-[15rem]"> <span className="!text-c-red">
                            <TypingAnimation 
                                strings={["Hello I'm Prince Adimado", 'A Software Developer', 'And I do Frontend Development Currently']}
                                typeSpeed={70}
                                backSpeed={30}
                                loop={true}
                            />
                        ...
                        <div className="text-center sm-425:text-center lg:px-[15rem] s">
                            <p className="text-txt-gray text-base break-words p-3">
                                With <span className="bg-c-red text-white px-1">{ experience } years</span>  of experience in web development with understanding in Backend Development with Django and <span className="!text-c-red font-semibold">Frontend Development</span> {' '} 
